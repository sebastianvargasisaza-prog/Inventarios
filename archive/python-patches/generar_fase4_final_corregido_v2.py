...
print("Regenerando SQL con columnas correctas (codigo_lote)...")
...
# SQL LOTES - CORREGIDO: codigo_lote en lugar de lote
insert_lotes = []
...
print(f"✓ SQL corregido generado: FASE_4_INVENTARIO_CARGABLE_CORREGIDO.sql")
print(f"  Materiales: {len(mapeo_materiales)}")
print(f"  Lotes: {len(lotes_data)}")
print(f"  Cambio: 'lote' → 'codigo_lote'")
