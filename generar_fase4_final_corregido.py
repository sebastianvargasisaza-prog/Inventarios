...
print("Regenerando SQL con columnas correctas...")
...
# SQL MATERIALES - CORREGIDO: nombre_mp y nombre_inci con el mismo valor
sql_mat = []
...
SELECT m.id, t.lote, t.ubicacion, t.cantidad, t.fecha_vencimiento, CURRENT_DATE, TRUE
FROM (VALUES
""" + ",\n".join(insert_lotes) + """
...
with open("FASE_4_INVENTARIO_CARGABLE.sql", "w", encoding="utf-8") as f:
    f.write(sql_final)

print(f"✓ SQL generado: FASE_4_INVENTARIO_CARGABLE.sql")
