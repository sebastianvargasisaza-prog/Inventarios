MODULOS_HTML = (
    ...
    "      <a class=\"mod-card\" href=\"/marketing\" style=\"background:linear-gradient(135deg,rgba(212,175,55,.12),rgba(212,175,55,.04));border-color:rgba(212,175,55,.25)\"><span class=\"mod-icon\">&#x2726;</span><span class=\"mod-name\" style=\"color:#d4af37\">\xc1NIMUS Lab</span></a>\n"
    "    </div>\n"
    "  </div>\n"
    "\n"
    "  <div class=\"section\">\n"
