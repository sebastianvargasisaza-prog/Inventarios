...
<div class="tabs">
  ...
  <div class="tab" data-tip="Expediente por lote: buscá un lote y ves TODOS sus documentos (F01, F02, COA, rótulo, batch record) en un lugar · para auditoría INVIMA (zero-paper)." data-tip-pos="bottom" onclick="window.location.href='/calidad/expediente'">&#128193; Expediente por lote</div>
  <div class="tab" data-tip="Maestro de lotes: por cada lote, cuántas unidades debían salir de ese granel, cuántas se envasaron de verdad, la diferencia y si ya se liberaron · con el desglose por presentación y para qué cliente es." data-tip-pos="bottom" onclick="window.location.href='/calidad/maestro-lotes'">&#128202; Maestro de lotes</div>
