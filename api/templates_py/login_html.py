...
<link rel="icon" type="image/x-icon" href="/static/favicon.ico?v=eos2">
<link rel="icon" type="image/png" sizes="32x32" href="/static/icons/favicon-32.png?v=eos2">
<link rel="apple-touch-icon" sizes="180x180" href="/static/icons/apple-touch-icon-180.png?v=eos2">
<style>
