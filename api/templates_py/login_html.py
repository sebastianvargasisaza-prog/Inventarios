...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',system-ui,sans-serif;background:radial-gradient(ellipse at top,#1e1b4b 0%,#0f172a 50%,#0a0a0f 100%);min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:20px;color:var(--cx-border);}
...
.brand-tag{color:var(--cx-primary-light);font-size:12px;font-style:italic;margin-bottom:14px;}
.brand-by{color:var(--cx-text-mute);font-size:10px;text-transform:uppercase;letter-spacing:1.5px;}
.brand-by strong{color:var(--cx-border);}
label{display:block;color:var(--cx-text-faint);font-size:0.8em;font-weight:700;margin-bottom:8px;text-transform:uppercase;letter-spacing:0.5px;}
.fg{margin-bottom:20px;}
input[type=text],input[type=password]{width:100%;background:rgba(15,23,42,0.6);border:1px solid var(--cx-text-soft);border-radius:10px;padding:14px 16px;color:white;font-size:1em;outline:none;transition:.2s;}
input[type=text]:focus,input[type=password]:focus{border-color:var(--cx-primary-light);background:rgba(15,23,42,0.9);box-shadow:0 0 0 3px rgba(167,139,250,0.15);}
...
.users-hint{text-align:center;color:var(--cx-text-soft);font-size:0.78em;margin-top:14px;margin-bottom:4px;}
.back{text-align:center;margin-top:18px;}
.back a{color:var(--cx-text-mute);font-size:0.83em;text-decoration:none;}
.back a:hover{color:var(--cx-primary-light);}
.app-footer{margin-top:32px;text-align:center;font-size:10px;color:var(--cx-text-soft);letter-spacing:0.5px;line-height:1.6;}
.app-footer strong{color:var(--cx-text-faint);}
...
<div class="card">
  <div class="logo">
    <span class="brand-mark" style="display:inline-flex;align-items:center;justify-content:center;color:var(--cx-primary-text);" aria-label="EOS">
...
<footer class="app-footer">
  ...
  <div style="margin-top:6px;color:var(--cx-text-soft);">&copy; 2026 HHA Group S.A.S. &middot; Todos los derechos reservados</div>
</footer>
</body>
</html>"""
