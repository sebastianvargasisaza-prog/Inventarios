...
<div id="app-screen" class="app" style="display:none">
  <header class="cx-mod-header cx-fade-in">
    ...
    <div>
      ...
      <div class="cx-mod-header__sub"><strong>Cortex Labs</strong> &middot; facturación · cartera · tesorería · nómina &middot; <span id="topbar-user" style="color:#a8a29e"></span></div>
    </div>
