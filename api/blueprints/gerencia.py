...
def gerencia_dashboard_extra():
    ...
    # Valor inventario MP en COP · sale del kardex canonico.
    # 19-ago · se retira la consulta que leia la tabla `lotes`, que NO EXISTE en este
    # esquema: fallaba siempre, el `except` la dejaba en 0 y recien entonces corria
    # este camino. El numero que se mostraba ya era el correcto (el arreglo del 25-jul),
    # pero cada carga pagaba una consulta imposible -- y en PostgreSQL, su rollback.
    try:
        _filas = c.execute(
