...
def generar_rotulos(producto_nombre, cantidad_str):
    ...
    css=('<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Rotulos</title>'
         ...
         'td{padding:7px 14px;border-top:1px solid var(--line);vertical-align:middle;font-size:12px;}'
         'td.k{width:26%;color:var(--mute);font-weight:700;font-size:9.5px;text-transform:uppercase;letter-spacing:.3px;background:#fafafa;white-space:nowrap;}'
         '.num{font-variant-numeric:tabular-nums;font-weight:600;}.cod{color:#a1a1aa;font-size:.85em;}.inci{font-size:11px;color:var(--soft);}'
