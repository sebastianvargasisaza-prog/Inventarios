...
def importar_conteo_page():
    ...
    html = (
        ...
        '+"<span style=font-size:13px>Ver: <button data-cat=saldo onclick=verCat(this.dataset.cat) style=\\"background:#e2e8f0;color:#1e293b\\">con saldo</button> <button data-cat=problema onclick=verCat(this.dataset.cat) style=\\"background:#fee2e2;color:#991b1b\\">⚠ problemas</button> <button data-cat=todas onclick=verCat(this.dataset.cat) style=\\"background:#e2e8f0;color:#1e293b\\">todas</button></span>"'
        '+"<span style=\\"font-size:12px;color:#64748b\\">Por defecto se ven solo las que tienen saldo. Los ⚠ (INCI distinto / sin match) NO se marcan: revisalos antes. Marcá lo que contaste y cargá.</span></div>";'
        ...
        'var cat=(x.cantidad<=0)?"cero":(prob?"problema":"saldo");'
        ...
        'h+="</tbody></table>"; document.getElementById("tabla").innerHTML=h; actBtn(); verCat("saldo");'
        ...
        'window.verCat=function(cat){document.querySelectorAll("#tabla tbody tr").forEach(function(tr){var c=tr.getAttribute("data-cat");var show=(cat==="todas")||(cat==="saldo"&&(c==="saldo"||c==="problema"))||(cat==="problema"&&c==="problema");tr.style.display=show?"":"none";});};'
