...
CORAZON=(
  ...
  "tests/test_caja_libro_contadora.py" "tests/test_tesoreria_caja_menor.py" "tests/test_caja_llega_al_libro_central.py" "tests/test_ingreso_se_cuenta_una_vez.py" "tests/test_gastos_llegan_al_libro.py" "tests/test_acondicionamiento_no_descuenta_doble.py" "tests/test_cadena_envase_una_sola_vez.py" "tests/test_rotulos_en_bloque.py" "tests/test_f01_f02_estibas_y_fechas.py" "tests/test_cc_review_funciona_en_las_dos_pantallas.py" "tests/test_botones_apuntan_a_algo_real.py" "tests/test_saldo_caja_dice_de_cuando_es.py" "tests/test_financiero_sin_residuo.py"
