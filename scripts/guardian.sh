...
CORAZON=(
  ...
  "tests/test_planta_no_saca_al_usuario_de_la_vista.py"
  ...
  # "Aprobe la solicitud y se me perdio" (Catalina): aprobada sin OC, la lista filtra
  ...
  "tests/test_acond_lista_dice_sus_unidades.py"
  "tests/test_liberar_crea_stock_vendible.py"
